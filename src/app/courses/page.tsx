        ...
        <div key={courseType} className="mb-8">
          ...
          <table className="min-w-full table-fixed border-collapse border border-gray-300 ">
            ...
            <thead className={`${threadColor(courseType)} text-white`}>
              <tr>
                <th className="w-0 border border-gray-300 px-4 py-2 ">Kursusnummer</th> 
                <th className="w-2/4 border border-gray-300 py-2 ">Kursusnavn</th> 
                <th className="w-0 border border-gray-300 py-2 ">ECTS</th> 
                <th className="w-1/4 border border-gray-300 py-2 ">Placering</th> 
              </tr>
            </thead>
            <tbody>
              {courses.map((c) => (
